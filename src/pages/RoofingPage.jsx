...
export default function RoofingPage() {
  return (
    <ServicePageLayout
      title="屋根リフォーム（C/guard工法）"
      subtitle="築15～30年のコロニアル屋根に最適な、賢いリフォーム術"
      seoTitle="屋根リフォーム（C/guard工法）"
      seoDescription="福井県の屋根リフォームなら建築鈑金はた。C/guard（シーガード）カバー工法で葺き替えより費用を約20%削減。築15～30年のコロニアル屋根に最適。無料点検実施中。"
      serviceName="屋根リフォーム（C/guard工法）"
      priceRange="150〜250万円"
      breadcrumbItems={[{ label: '屋根リフォーム' }]}
      faqItems={faqData.roof.items}
    >
      {/* 結論ボックス */}
      <div className="bg-emerald-50 border-l-4 border-emerald-600 p-6 rounded-r-lg">
        <p className="text-lg text-slate-800 leading-relaxed">
          ...
          葺き替えの約20%コストカットが可能です。解体不要・工期短縮・断熱性UPの三拍子で、
          住みながらリフォームできます。
        </p>
      </div>
